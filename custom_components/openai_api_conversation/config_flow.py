...
class OpenAIAPIConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for OpenAI API Conversation."""
    ...
    def async_get_options_flow(
        ...
        return OpenAIAPIOptionsFlow(config_entry)


class OpenAIAPIOptionsFlow(OptionsFlow):
    """OpenAI API config flow options handler."""
...
def openai_api_config_option_schema(
    ...
    """Return a schema for OpenAI API completion options."""
